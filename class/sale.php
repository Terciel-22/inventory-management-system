<?php 
    ...
    class Sale extends PDOHandler
    {
        ...
        // function updateSale($saleDate,$saleCustomerID,$saleCustomerName,$saleItemNumber,$saleItemName,$saleItemDiscount,$saleItemQuantity,$saleItemUnitPrice,$saleID)
        // {
        //     //Update item stock
        //     $sql1 = "UPDATE item SET stock = stock + :quantity WHERE itemNumber = :itemNumber";
        //     $this->pdo->prepareQuery($sql1);
        ...
        //     //Add new sale
        //     $sql2 = "UPDATE sale SET itemNumber = :itemNumber, saleDate = :saleDate, itemName = :itemName, unitPrice = :unitPrice, quantity = :quantity, vendorName = :vendorName, vendorID = :vendorID WHERE saleID = :saleID";
        //     $this->pdo->prepareQuery($sql2);
        //     $this->pdo->bindValueToStatement(":itemNumber",$saleItemNumber);
        //     $this->pdo->bindValueToStatement(":saleDate",$saleDate);
        //     $this->pdo->bindValueToStatement(":itemName",$saleItemName);
        //     $this->pdo->bindValueToStatement(":unitPrice",$saleUnitPrice);
        //     $this->pdo->bindValueToStatement(":quantity",$saleItemQuantity);
        //     $this->pdo->bindValueToStatement(":vendorName",$saleVendorName);
        //     $this->pdo->bindValueToStatement(":vendorID",$saleVendorID);
        //     $this->pdo->bindValueToStatement(":saleID",$saleID);
    ...
    //     $saleDate = htmlentities($_POST["sale-date"]);
    //     $saleItemName = htmlentities($_POST["sale-item-name"]);
    //     $saleUnitPrice = htmlentities($_POST["sale-item-unit-price"]);
    //     $saleItemQuantity = htmlentities($_POST["sale-item-quantity"]);
    //     $saleVendor = htmlentities($_POST["sale-vendor-name"]);
    //     $saleLastQuantity = htmlentities($_POST["sale-last-quantity"]);

    //     if($saleID != "" && $saleItemNumber != "" && $saleDate != "" && $saleVendor != "" && $saleItemQuantity != "" && $saleUnitPrice != "")
    //     {
    //         if(!$sale->checkIfItemNumberExist($saleItemNumber))
    //         {
    //             echo "Your item number doesn't exist.";
    ...
    //             exit();
    //         }
    //         if(!is_numeric($saleUnitPrice) || $saleUnitPrice < 0){
    //             echo "Please put a valid unit price.";
    //             exit();
    //         }

    //         if($saleItemQuantity != $saleLastQuantity)
    //         {
    //             $itemQuantity = $saleItemQuantity - $saleLastQuantity;
    //         } else
    //         {
    //             $itemQuantity = 0;
    //         }
 
    //         $saleVendorArr = explode("|",$saleVendor);
    //         $saleVendorID = $saleVendorArr[1];
    //         $saleVendorName = $saleVendorArr[0];

    //         $isUpdated = $sale->updateSale($saleItemNumber,$saleDate,$saleItemName,$saleUnitPrice,$itemQuantity,$saleItemQuantity,$saleVendorName,$saleVendorID,$saleID);
